...
// cgo -godefs -- -m64 /export/home/tetter/go/src/github.com/chihsieh-tetration/sys/unix/_const.go
...
const (
	...
	MCL_CURRENT			= 0x1
	MCL_FUTURE			= 0x2
	MEMINFO_MASK			= 0xff0000
	MEMINFO_MC_ALIGNMENT		= 0xa0000
	MEMINFO_PLGRP			= 0x70000
	MEMINFO_SHIFT			= 0x10
	MEMINFO_VADI			= 0x80000
	MEMINFO_VLGRP			= 0x20000
	MEMINFO_VMEMTYPE		= 0x90000
	MEMINFO_VPAGESIZE		= 0x30000
	MEMINFO_VPHYSICAL		= 0x10000
	MEMINFO_VREPL			= 0x50000
	MEMINFO_VREPLCNT		= 0x40000
	MEMINFO_VREPL_LGRP		= 0x60000
	MSG_CMSG_CLOEXEC		= 0x2000
	MSG_CMSG_CLOFORK		= 0x4000
	MSG_CTRUNC			= 0x10
	MSG_DONTROUTE			= 0x4
	MSG_DONTWAIT			= 0x80
	MSG_DUPCTRL			= 0x800
