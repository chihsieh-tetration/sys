...
func pipe2(p *[2]_C_int, flags int) (err error) {
	_, e1 := callpipe2(uintptr(unsafe.Pointer(p)), flags)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func ioctlPtrRet(fd int, req int, arg unsafe.Pointer) (ret int, err error) {
	r0, e1 := callioctl(fd, req, uintptr(arg))
	ret = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func ClockGettime(clockid int32, time *Timespec) (err error) {
	_, e1 := callclock_gettime(clockid, uintptr(unsafe.Pointer(time)))
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func port_associate(port int, source int, object uintptr, events int, user *byte) (n int, err error) {
	r0, e1 := callport_associate(port, source, object, events, uintptr(unsafe.Pointer(user)))
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func port_dissociate(port int, source int, object uintptr) (n int, err error) {
	r0, e1 := callport_dissociate(port, source, object)
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func port_get(port int, pe *portEvent, timeout *Timespec) (n int, err error) {
	r0, e1 := callport_get(port, uintptr(unsafe.Pointer(pe)), uintptr(unsafe.Pointer(timeout)))
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func port_getn(port int, pe *portEvent, max uint32, nget *uint32, timeout *Timespec) (n int, err error) {
	r0, e1 := callport_getn(port, uintptr(unsafe.Pointer(pe)), max, uintptr(unsafe.Pointer(nget)), uintptr(unsafe.Pointer(timeout)))
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func putmsg(fd int, clptr *strbuf, dataptr *strbuf, flags int) (err error) {
	_, e1 := callputmsg(fd, uintptr(unsafe.Pointer(clptr)), uintptr(unsafe.Pointer(dataptr)), flags)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func getmsg(fd int, clptr *strbuf, dataptr *strbuf, flags *int) (err error) {
	_, e1 := callgetmsg(fd, uintptr(unsafe.Pointer(clptr)), uintptr(unsafe.Pointer(dataptr)), uintptr(unsafe.Pointer(flags)))
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
